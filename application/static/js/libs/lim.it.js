    ...
    if($.fn.nivoSlider){
        $('#slider').nivoSlider(
          ...
          beforeChange:function(){
            ...
            var currentNavEl = vars.controlNavEl;
            var currentSlide = vars.currentSlide;
            var totalSlides = vars.totalSlides;
            if(currentSlide == vars.totalSlides-1){
                var st = 0;
            }else{
                var nextSlide = vars.currentSlide;
                var st =  -currentNavEl.children().filter('.active').height()*(nextSlide);
            }
